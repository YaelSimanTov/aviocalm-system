...
// Change password function
  ...
  const changePassword = async (oldPassword, newPassword) => {
    ...
    // שינוי קטן: עדיף להדליק טעינה מאשר להתחיל "תהליך התחברות" שמוחק שגיאות
    ...
    try {
      ...
      if (result.success) {
        ...
        // התיקון הקריטי: לא מנתקים את המשתמשת! רק מפסיקים את הטעינה
      ...
      // גם כאן: רק מפסיקים טעינה ולא מנתקים
